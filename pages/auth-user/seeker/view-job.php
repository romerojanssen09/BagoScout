...
// Check if the request is a POST and not a page refresh after form submission
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_SESSION['form_submitted'])) {
    if (isset($_POST['action'])) {
        // Set a session flag to prevent duplicate submissions on refresh
        ...
        header("Location: view-job.php?id=" . $jobId .
            (!empty($commentSuccess) ? "&success=" . urlencode($commentSuccess) : "") .
            (!empty($commentError) ? "&error=" . urlencode($commentError) : ""));
        exit();
    }
} else {
    // Clear the form submission flag when loading the page normally
    unset($_SESSION['form_submitted']);

    // Check for success or error messages from redirects
    if (isset($_GET['success'])) {
        $commentSuccess = $_GET['success'];
    }
    if (isset($_GET['error'])) {
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-2/3">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="flex items-center mb-4">
                    <a href="../../auth-user/employer-profile.php?id=<?php echo $job['employer_id']; ?>" class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-gray-800 hover:text-blue-600"><?php echo htmlspecialchars($job['company_name']); ?></h2>
        ...
        <div class="w-full md:w-1/3">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="mt-4">
                    <a href="message.php?receiver=<?php echo $job['user_id']; ?>" class="inline-block w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded text-center">
