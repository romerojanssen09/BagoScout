...
// Get employer ID from URL or use current user's ID
$isOwnProfile = false;
if (isset($_GET['id'])) {
...
$jobsStmt = $conn->prepare("SELECT id, title, location, job_type, pay_type, salary_min, created_at 
                           FROM jobs 
...
// Set page title
$pageTitle = "Employer Profile: " . htmlspecialchars($employer['company_name']);
...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex space-x-2">
        ' . ($isOwnProfile ? '
        <a href="settings.php" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition duration-300 flex items-center">
...
if (count($recentJobs) > 0) {
    ...
    foreach ($recentJobs as $job) {
        $content .= '
        <a href="../seeker/view-job.php?id=' . $job['id'] . '" class="block">
    ...
    if (count($recentJobs) == 5) {
        ...
        <div class="mt-4 text-center">
            <a href="../seeker/jobs.php?employer=' . $employerId . '" class="text-blue-600 hover:text-blue-800 font-medium">
...
$content .= '
                ...
                <div class="mt-6 flex flex-col space-y-2">
                    <a href="../../../pages/auth-user/message.php?to=' . $employer['user_id'] . '" class="w-full px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition duration-300 text-center">
