...
<div class="flex flex-col h-full bg-gray-800 text-white">
    ...
    <div class="flex-grow overflow-y-auto py-2">
        <nav class="px-2">
            ...
            <a href="post-job.php" class="flex items-center py-2 px-4 rounded-md mb-1 <?php echo $currentPage === 'post-job.php' ? 'bg-blue-600 text-white' : ($user['status'] == 'unverified' ? 'text-gray-500 cursor-not-allowed' : 'text-gray-300 hover:bg-gray-700'); ?>">
                <i class="fas fa-plus-circle w-5 mr-3"></i>
                <span>Post Job</span>
            </a>

            <a href="manage-jobs.php" class="flex items-center py-2 px-4 rounded-md mb-1 <?php echo $currentPage === 'manage-jobs.php' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700'; ?>">
                <i class="fas fa-briefcase w-5 mr-3"></i>
                <span>Manage Jobs</span>
            </a>

            <a href="map.php" class="flex items-center py-2 px-4 rounded-md mb-1 <?php echo $currentPage === 'map-employer.php' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700'; ?>">
                <i class="fas fa-map-marker-alt w-5 mr-3"></i>
                <span>Jobs Map</span>
            </a>

            <a href="candidates.php" class="flex items-center py-2 px-4 rounded-md mb-1 <?php echo $currentPage === 'candidates.php' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700'; ?>">
